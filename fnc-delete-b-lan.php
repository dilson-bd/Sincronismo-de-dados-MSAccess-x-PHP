...
try{
/*Realiza direto a exclusão em cima do idpassado pela url*/
       $stmte = $conecta->getConectar()->exec("DELETE FROM lancamentos WHERE CodWeb_b =".$_GET['codweb']);
       $excl = "Excluido";
	   echo $CodWeb_b . ";" . $excl;
   }catch(PDOException $e){
       echo 'Erro', PHP_EOL;
